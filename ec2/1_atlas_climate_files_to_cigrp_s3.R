...
chirps_monthlytotal_mosaic <- mosaic_rasters(chirps_monthlytotal_in,
...
chirps_trend_mosaic <- mosaic_rasters(chirps_trend_in,
                                      chirps_trend_out,
                                      output_Raster=TRUE)
...
#TODO: Need to calculate CRU climatology
